  ...
  return (
    <Box sx={{ minHeight: "100vh", backgroundColor: "#f5f5f5", display: "flex", justifyContent: "center", alignItems: "center", py: 6, px: 2 }}>
      <Paper elevation={3} sx={{ width: "100%", maxWidth: "480px", p: 5, borderRadius: "18px", background: "#fff" }}>
        ...
        <Typography sx={{ textAlign: "center", mb: 4, color: "#666", fontSize: "15px" }}>
          {t("Join Boimela and start your journey!")}
        </Typography>
        ...
        <Box component="form" onSubmit={handleSubmit((values) => registerMutation.mutate(values))} sx={{ display: "flex", flexDirection: "column", gap: 2.8 }}>
          <TextField label={t("User Name")} {...register("userName")} fullWidth variant="outlined" error={!!errors.userName} helperText={errors.userName?.message} />
          <TextField label={t("Full Name")} {...register("fullName")} fullWidth variant="outlined" error={!!errors.fullName} helperText={errors.fullName?.message} />
          <TextField label={t("Email")} {...register("email")} fullWidth variant="outlined" error={!!errors.email} helperText={errors.email?.message} />
          <TextField label={t("Password")} {...register("password")} fullWidth variant="outlined" error={!!errors.password} helperText={errors.password?.message} />
          <TextField label={t("PhoneNumber")} {...register("phoneNumber")} fullWidth variant="outlined" error={!!errors.phoneNumber} helperText={errors.phoneNumber?.message} />
        ...
        <Typography sx={{ mt: 3, textAlign: "center" }}>
          {t("Already have an account?")} <Link to="/auth/login" style={{ color: "#ff6b6b", fontWeight: 600, textDecoration: "none" }}>{t("Login")}</Link>
        </Typography>
      </Paper>
    </Box>
  );
